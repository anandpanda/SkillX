...
const runningCourses: Course[] = [
  { id: '1', title: 'Mathematics for Engineers', students: 50 , image: 'https://media.geeksforgeeks.org/wp-content/cdn-uploads/20200214165928/Web-Development-Course-Thumbnail.jpg',},
  { id: '2', title: 'Business Marketing', students: 40 ,image: 'https://media.geeksforgeeks.org/wp-content/cdn-uploads/20200214165928/Web-Development-Course-Thumbnail.jpg',},
];
...
const scheduledClasses: ScheduledCourse[] = [
  { id: '1', title: 'Algebra Basics', time: '10:00 - 11:00 AM' , image : 'https://media.geeksforgeeks.org/wp-content/cdn-uploads/20200214165928/Web-Development-Course-Thumbnail.jpg'},
  { id: '2', title: 'Digital Marketing', time: '2:00 - 3:00 PM' , image: 'https://media.geeksforgeeks.org/wp-content/cdn-uploads/20200214165928/Web-Development-Course-Thumbnail.jpg'},
];
    ...
    <View style={styles.container}>
      ...
      <View style={styles.summaryContainer}>
        <View style={[styles.summaryBox , styles.color1]}>
          <Text style={styles.summaryNumber}>{todaySummary.studentsPresent}</Text>
          <Text style={styles.summaryLabel}>Students Present</Text>
        </View>
        <View style={[styles.summaryBox , styles.color2]}>
          <Text style={styles.summaryNumber}>{todaySummary.classesCompleted}</Text>
          <Text style={styles.summaryLabel}>Classes Completed</Text>
        </View>
        <View style={[styles.summaryBox , styles.color3]}>
          <Text style={styles.summaryNumber}>{todaySummary.assignmentsDue}</Text>
